...
import (
	docs "github.com/swiggy-2022-bootcamp/cdp-team3/reward-service/docs"

	"github.com/gin-gonic/gin"
	swaggerFiles "github.com/swaggo/files"
	ginSwagger "github.com/swaggo/gin-swagger"
	"github.com/swiggy-2022-bootcamp/cdp-team3/reward-service/controllers"
	"github.com/swiggy-2022-bootcamp/cdp-team3/reward-service/routes"
)
...
func main() {
	...
	docs.SwaggerInfo.Title = "BuyItNow Reward Service"

	routes.RewardRoute(router)
	router.Run(":3008")
}
